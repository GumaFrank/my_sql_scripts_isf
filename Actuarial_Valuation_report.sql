...
SELECT A.V_POLICY_NO,
 ...
 WHERE     A.V_PLAN_CODE = B.V_PLAN_CODE
       ...
       AND A.V_PLAN_CODE NOT LIKE 'FSC%'
       AND TRUNC( D_COMMENCEMENT) BETWEEN  '01-NOV-2023' AND '30-NOV-2023'
       )
       WHERE V_STATUS_DESC = 'IN-FORCE'--)
